...
.extern fopen, fclose, fscanf, fprintf, printf, malloc, free
...
fmt_char:   .asciz "%c"
fmt_taxa:   .asciz "[%d%%]\n"
err_msg:    .asciz "Erro: argumentos invalidos ou arquivo inexistente.\n"
...
le_tuplas:
    ...
    # largura = max(largura, x + run)
    mov ecx, dword ptr [rbx]      # x
    mov edx, dword ptr [rbx+8]    # rp
    shr edx, 4                    # run
    add ecx, edx                  # x + run
