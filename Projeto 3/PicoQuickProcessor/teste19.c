...
/* VERSAO_FINAL_SEM_CORTE_ARTIFICIAL: não corta a execução por quantidade de instruções. */
#define LIMITE_INSTRUCOES 0ULL

/*
 * WATCHDOG_TEMPO_US = 0 na versão final correta.
 * A execução não é cortada por tempo; ela deve terminar pelo fluxo do bytecode.
 */
