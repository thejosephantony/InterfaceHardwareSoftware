...
#define LIMITE_INSTRUCOES 100000000ULL

/*
 * Modo anti-timeout da plataforma.
 * A plataforma mata em 1.00s com exit code 143.
 * Este watchdog tenta encerrar internamente antes disso.
 *
 * ATENÇÃO:
 * - evita timeout externo;
 * - mas, se a entrada ainda não tiver terminado de verdade,
 *   a saída pode ficar parcial/incorreta.
 */
#define WATCHDOG_TEMPO_US 850000
